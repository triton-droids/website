...
test.describe('Carousel Visual Testing', () => {
  test('AchieveSection carousel visual test', async ({ page }) => {
    ...
    const carousel = page.locator('div').filter({ has: page.locator('h3:has-text("Leveraging UCSD\'s Unique Assets")') }).first();
  ...
  test('WhyJoinCarousel visual test', async ({ page }) => {
    ...
    // Take screenshot of the carousel
    const carousel = page.locator('div').filter({ has: page.locator('h3:has-text("Real world impact")') }).first();
    await carousel.screenshot({
  ...
  test('Carousel typography at different viewport sizes', async ({ page }) => {
    ...
    const carouselTablet = page.locator('div').filter({ has: page.locator('h3:has-text("Leveraging UCSD\'s Unique Assets")') }).first();
