          ...
          <div className="w-full">
            <div className="w-full bg-[#2A2B2D] rounded-[28px] lg:rounded-[40px] flex min-h-[20rem] md:min-h-[36rem] flex-col items-center justify-center text-center gap-6 md:gap-8 px-7 py-10 sm:px-10 sm:py-12 md:px-12 md:py-12 max-w-[1050px] mx-auto">
              ...
              <div className="w-full flex justify-center px-1">
                <div className="w-full max-w-[min(100%,300px)] aspect-square sm:max-w-[min(100%,360px)] md:aspect-[4/3] md:max-w-[min(100%,480px)] rounded-[20px] lg:rounded-[28px] overflow-hidden shrink-0">
                  <img
                    src={slide.image}
                    alt={slide.title}
              ...
              <p className="hidden md:block text-[16px] md:text-[18px] lg:text-[20px] text-main-text leading-[140%] font-normal max-w-xl mx-auto w-full text-center">
                {slide.description}
              </p>
            </div>
          </div>
